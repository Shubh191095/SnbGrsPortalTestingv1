...
public class SBIHealthCheck {
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		driver.get("http://10.180.184.30:8080/integration-web-launcher/SBI/ws/healthcheck");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
		
//===================================	======================================================================================
//Check URL		
		  String expectedURL ="http://10.180.184.30:8080/integration-web-launcher/SBI/ws/healthcheck";
...
//=========================================================================================================================	           
    ...
    //(BALANCE_ENQUIRY)
    		expectedResponse= "";
    		if(actualResponse.contains(expectedResponse)) System.out.println("Response are matching SBI (BALANCE_ENQUIRY) .. PASSED");
    		else System.out.println("FAIL");
    ...
    //(STATUS_ENQUIRY)
    		expectedResponse= "";
            if(actualResponse.contains(expectedResponse)) System.out.println("Response are matching SBI (STATUS_ENQUIRY)  .. PASSED");
            else System.out.println("FAIL");
    ...
    //(PAYOUT)
        	expectedResponse= "";
            if(actualResponse.contains(expectedResponse)) System.out.println("Response are matching SBI (PAYOUT)          .. PASSED");
            else System.out.println("FAIL");
