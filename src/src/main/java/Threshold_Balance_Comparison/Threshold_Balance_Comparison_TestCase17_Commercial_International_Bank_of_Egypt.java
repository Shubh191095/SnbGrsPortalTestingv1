...
public class Threshold_Balance_Comparison_TestCase17_Commercial_International_Bank_of_Egypt {
	//<option value="Commercial International Bank of Egypt">Commercial International Bank of Egypt</option>
...
//=====================================================================================================================================		
		...
		driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[18]")).click();
		Thread.sleep(2000);
