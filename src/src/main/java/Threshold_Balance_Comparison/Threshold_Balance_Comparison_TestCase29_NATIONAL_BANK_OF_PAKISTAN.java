...
public class Threshold_Balance_Comparison_TestCase29_NATIONAL_BANK_OF_PAKISTAN {
...
//=====================================================================================================================================		
		...
		driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[30]")).click();
		Thread.sleep(2000);
