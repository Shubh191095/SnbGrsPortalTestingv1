...
public class Threshold_Balance_Comparison_TestCase39_Tadhamon_Bank {
//<option value="Tadhamon Bank">Tadhamon Bank</option>
...
//=====================================================================================================================================		
		...
		driver.findElement(By.xpath("/html/body/div/div[1]/div/div/div/section/div/div/div/div[2]/div/div[1]/select/option[40]")).click();
		Thread.sleep(2000);
